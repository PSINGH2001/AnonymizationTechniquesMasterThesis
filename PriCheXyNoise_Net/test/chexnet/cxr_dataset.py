...
class CXRDataset(Dataset):
    def __init__(self, path_to_images, fold, transform=None, sample=0, finding="any", perturbation_type='none'):
        ...
        self.df = pd.read_csv('/home/woody/iwi5/iwi5155h/GaussianNoise/Noise_0.1/test/chexnet/nih_labels.csv')
        self.df = self.df[self.df['fold'] == fold]
        self.transform = transform
        self.perturbation_type = perturbation_type

        if self.perturbation_type in ['flow_field', 'privacy_net', 'dp_pix','noise']:
