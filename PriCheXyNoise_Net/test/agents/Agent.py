...
class Agent:
    def __init__(self, config):
        ...
        self.deformation_degree = self.config['noise_degree']
        self.num_workers = 8
        ...
        elif self.generator_type == 'noise':
            self.grid_identity = None
            self.gauss_filter = None
            self.generator = UNet(1, 1, 32).cuda()
        ...
        self.optimizer_g = optim.Adam(self.generator.parameters(), lr=self.learning_rate, weight_decay=1e-4)
    ...
    def training_validation(self):
        ...
        for epoch in range(self.start_epoch, self.max_epochs):
            ...
            train_losses = utils.train(self.generator, self.training_loader, self.gauss_filter, self.grid_identity, 
                                       ...
                                       self.show_every_n_epochs, self.show_every_n_iterations, self.SAVINGS_PATH, self.deformation_degree)
            ...
            val_losses = utils.validate(self.generator, self.validation_loader, self.gauss_filter, self.grid_identity, 
                                        ...
                                        self.show_every_n_iterations, self.SAVINGS_PATH, self.deformation_degree)
