...
from utils.utils import getMaskSegmentation
from networks.Segmentation_Hybrid_Gnet import Segmentation_Hybrid_Gnet
...
def make_pred_multilabel(data_transforms, model, image_path, save_path, perturbation_type='none', 
    ...
    segmentation_model = Segmentation_Hybrid_Gnet()
    # Create dataloader
    ...
    for i, data in enumerate(dataloader):
        ...
        if perturbation_type == 'flow_field':
            ...
            mask = getMaskSegmentation(inputs, segmentation_model)
